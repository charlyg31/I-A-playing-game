...
class LongTermMemory:
    def __init__(self, memory_file="long_term_memory.pkl"):
    ...
    def add_event(self, event):
        """
Enregistre un événement (par exemple, l'action de fusion ou un événement particulier dans le jeu).
        """
...
self.memory[data_type].pop(index, None)
            self.save_memory()

    def get_memory_summary(self):
        """
        Retourne un résumé de la mémoire de l'IA, y compris les expériences, stratégies et événements.
        """
        return {
